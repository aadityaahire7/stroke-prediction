...
The dataset can be found in the [repository](https://github.com/adnanhakim/stroke-detection) or can be downloaded from [Kaggle](https://www.kaggle.com/fedesoriano/stroke-prediction-dataset)
